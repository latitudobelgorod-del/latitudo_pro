...
<head>
    ...
    <script type="text/javascript">
        ...
        ym(110963911, 'init', {ssr:true, webvisor:true, clickmap:true, referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
    </script>
    <!-- /Yandex.Metrika counter -->
    <? endif ?>
    ...
    <? // Envybox «Обратный звонок» (виджет cbk, код сайта 4752cf60…). Кнопка в углу экрана:
       ...
       // Захотите ужесточить — добавьте в условие ниже && $hasConsent, переменная уже есть.
       //
