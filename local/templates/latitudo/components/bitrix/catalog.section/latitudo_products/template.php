...
// не должны отваливаться. Атрибут data-empty — сигнал для JS в footer.php:
// по нему скрывается пункт меню «Цены», которому здесь некуда вести.
// Прятать пункт на сервере нельзя — меню одно на весь сайт, см. .top.menu.php.
if (empty($arResult['ITEMS'])): ?>
<div id="catalog" data-empty></div>
<?php return; endif; ?>
