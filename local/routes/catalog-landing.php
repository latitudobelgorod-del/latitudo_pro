...
// «Дилерам и партнёрам» рисует footer.php (он идёт после содержимого страницы), поэтому
// управляем им через глобальный флаг: галочка UF_SHOW_DEALERS снята — блока на лендинге
// нет. На главной и прочих страницах флаг не выставлен и блок показывается как раньше.
$GLOBALS['latitudoShowDealers'] = ((string)($section['UF_SHOW_DEALERS'] ?? '') === '1');
