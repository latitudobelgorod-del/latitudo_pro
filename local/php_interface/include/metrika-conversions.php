 ...
 *   кука '0' (отказ)          → НЕТ, при любых прочих условиях. Человек явно отказался
 *                               от аналитики; обходить его выбор сервером — то же самое,
 *                               что кнопка-обманка, ровно за это аудит выписал замечание.
 ...
 *
 * Порядок проверок значим: отказ перебивает всё остальное. Иначе у отказавшегося с
 * блокировщиком рекламы (сочетание частое — это один и тот же тип пользователя)
 * конверсия всё-таки уехала бы, мимо его прямого «нет».
 */
