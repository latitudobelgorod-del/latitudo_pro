 ...
 *   1. UF_VIDEO_SLIDER — строковое МНОЖЕСТВЕННОЕ: ссылки на ролики YouTube и Rutube
 *                        (по одной в строку, сервисы можно смешивать).
...
$fields = [
    ...
    [
        ...
        'HELP_MESSAGE'      => ['ru' => 'Ссылки на ролики YouTube или Rutube — по одной в строке, кнопка «Добавить» под полем. Подходит любой формат ссылки: youtube.com/watch?v=…, youtu.be/…, /shorts/…, rutube.ru/video/…. Ссылки двух сервисов можно смешивать. Обложка подставляется автоматически; если Rutube её не отдал, ролик показывается встроенным плеером. Порядок роликов в слайдере = порядок строк.'],
    ],
    // Выключатель блока.
    [
        'ENTITY_ID'         => $ufEntity,
