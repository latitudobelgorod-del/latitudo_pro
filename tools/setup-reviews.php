 ...
 *   2. Добавляет свойства DATE (дата отзыва), RATING (оценка) и PHOTOS (фото к отзыву).
...
$props = [
    [
        // Дата отзыва — отдельным свойством: поле «Активность с» контент-редакторы
        // не находят и вписывают даты прямо в имя автора. Шаблон latitudo_reviews
        // сначала смотрит это свойство, если пусто — берёт «Активность с».
        'IBLOCK_ID'     => $reviewsId,
        'NAME'          => 'Дата отзыва',
        'CODE'          => 'DATE',
        'PROPERTY_TYPE' => 'S',
        ...
        'ACTIVE'        => 'Y',
        'SORT'          => 90,
        'HINT'          => 'Дата, как указана в отзыве на Яндексе. Выводится в карточке отзыва на сайте.',
    ],
    [
        'IBLOCK_ID'     => $reviewsId,
        'NAME'          => 'Оценка (1–5)',
