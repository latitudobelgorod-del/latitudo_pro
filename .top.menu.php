...
// Первый пункт ведёт на #catalog, но блок за этим якорем разный: на главной это
// «Каталог продукции» (плитка разделов), на лендинге — таблица товаров с ценами.
// Отсюда и разные подписи. Считаем здесь, а не в шаблоне: MENU_CACHE_TYPE = "N"
// (header.php), меню собирается на каждой странице заново.
$isMainPage = in_array($GLOBALS['APPLICATION']->GetCurPage(false), ['/index.php', '/'], true);
